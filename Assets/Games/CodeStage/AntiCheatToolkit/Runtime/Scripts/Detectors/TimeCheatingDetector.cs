...
namespace CodeStage.AntiCheat.Detectors
{
	...
	public class TimeCheatingDetector : ACTkDetectorBase<TimeCheatingDetector>
	{
		...
		public struct OnlineTimeResult
		{
			...
			/// </summary>
			public long ErrorResponseCode { get { return errorResponseCode; } }
			
			/// <summary>
			/// UTC seconds value retrieved from the online server.
			/// </summary>
			public double OnlineSecondsUtc { get { return onlineSecondsUtc; } }
			
			/// <summary>
			/// UTC DateTime retrieved from the online server.
			/// </summary>
			public DateTime OnlineDateTimeUtc { get { return onlineDateTimeUtc; } }
